...
function sr(h) {
  ...
  if (typeof b == "function") {
    var y = function p() {
      return this instanceof p ? Reflect.construct(b, arguments, this.constructor) : b.apply(this, arguments);
    };
    y.prototype = b.prototype;
  } else
    y = {};
  return Object.defineProperty(y, "__esModule", { value: !0 }), Object.keys(h).forEach(function(p) {
    var R = Object.getOwnPropertyDescriptor(h, p);
    Object.defineProperty(y, p, R.get ? R : {
      enumerable: !0,
      get: function() {
        return h[p];
      }
...
function fr() {
  return Te || (Te = 1, process.env.NODE_ENV !== "production" && function() {
    var h = Ce, b = Symbol.for("react.element"), y = Symbol.for("react.portal"), p = Symbol.for("react.fragment"), R = Symbol.for("react.strict_mode"), I = Symbol.for("react.profiler"), x = Symbol.for("react.provider"), T = Symbol.for("react.context"), l = Symbol.for("react.forward_ref"), P = Symbol.for("react.suspense"), v = Symbol.for("react.suspense_list"), m = Symbol.for("react.memo"), O = Symbol.for("react.lazy"), $ = Symbol.for("react.offscreen"), Z = Symbol.iterator, Pe = "@@iterator";
    function we(e) {
    ...
    function Ae(e) {
      return !!(typeof e == "string" || typeof e == "function" || e === p || e === I || Fe || e === R || e === P || e === v || De || e === $ || je || xe || ke || typeof e == "object" && e !== null && (e.$$typeof === O || e.$$typeof === m || e.$$typeof === x || e.$$typeof === T || e.$$typeof === l || // This needs to include all possible module reference object
    ...
    var C = Object.assign, k = 0, re, te, ne, ae, oe, ie, ue;
    function se() {
    }
...
` + a[s].replace(" at new ", " at ");
    ...
    var L = Object.prototype.hasOwnProperty, le = {}, ce = w.ReactDebugCurrentFrame;
    function M(e) {
      if (e) {
    ...
    function ze(e, r) {
      if (typeof e.ref == "string" && D.current && r && D.current.stateNode !== r) {
        ...
        G[t] || (c('Component "%s" contains the string ref "%s". Support for string refs will be removed in a future major release. This case cannot be automatically converted to an arrow function. We ask you to manually fix this case by using useRef() or createRef() instead. Learn more about using refs safely here: https://reactjs.org/link/strict-mode-string-ref', E(D.current.type), e.ref), G[t] = !0);
      }
    }
    function Ke(e, r) {
      {
    ...
    var z = w.ReactCurrentOwner, he = w.ReactDebugCurrentFrame;
    function S(e) {
      if (e) {
        var r = e._owner, t = N(e.type, e._source, r ? r.type : null);
...
Check the top-level render call using <` + t + ">.");
    ...
    function me(e, r) {
      {
        ...
        ye[t] = !0;
        var n = "";
        e && e._owner && e._owner !== z.current && (n = " It was passed a child from " + E(e._owner.type) + "."), S(e), c('Each child in a list should have a unique "key" prop.%s%s See https://reactjs.org/link/warning-keys for more information.', t, n), S(null);
      }
    }
    function Ee(e, r) {
      {
    ...
    function _e(e, r, t, n, i, u) {
      {
        ...
        if (!o) {
          ...
          d ? a += d : a += be();
          var s;
          e === null ? s = "null" : J(e) ? s = "array" : e !== void 0 && e.$$typeof === b ? (s = "<" + (E(e.type) || "Unknown") + " />", a = " Did you accidentally export a JSX literal instead of a component?") : s = typeof e, c("React.jsx: type is invalid -- expected a string (for built-in components) or a class/function (for composite components) but got: %s.%s", s, a);
        }
        var f = Ze(e, r, t, i, u);
        if (f == null)
          return f;
    ...
    var or = ar, ir = nr;
    F.Fragment = p, F.jsx = or, F.jsxs = ir;
  }()), F;
}
var A = {};
/**
...
function lr() {
  if (Oe)
    return A;
  Oe = 1;
  var h = Ce, b = Symbol.for("react.element"), y = Symbol.for("react.fragment"), p = Object.prototype.hasOwnProperty, R = h.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, I = { key: !0, ref: !0, __self: !0, __source: !0 };
  function x(T, l, P) {
    var v, m = {}, O = null, $ = null;
    P !== void 0 && (O = "" + P), l.key !== void 0 && (O = "" + l.key), l.ref !== void 0 && ($ = l.ref);
    for (v in l)
      p.call(l, v) && !I.hasOwnProperty(v) && (m[v] = l[v]);
    if (T && T.defaultProps)
      for (v in l = T.defaultProps, l)
        m[v] === void 0 && (m[v] = l[v]);
    return { $$typeof: b, type: T, key: O, ref: $, props: m, _owner: R.current };
  }
  return A.Fragment = y, A.jsx = x, A.jsxs = x, A;
}
process.env.NODE_ENV === "production" ? X.exports = lr() : X.exports = fr();
var V = X.exports;
const cr = () => /* @__PURE__ */ V.jsx("div", { children: /* @__PURE__ */ V.jsx("span", { children: "Test" }) }), dr = () => /* @__PURE__ */ V.jsx("div", { children: /* @__PURE__ */ V.jsx("span", { children: "Test2" }) });
export {
  cr as TestComponent,
  dr as TestComponent2
};
